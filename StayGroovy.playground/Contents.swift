...
* mobile device.
* Progam your own shader function in `keepOnTruckin` in StayGroovy.metal. You
...
do {
  let path = Bundle.main.path(forResource: "StayGroovy", ofType: "metal")
...
renderer.functionName = "keepOnTruckin"
